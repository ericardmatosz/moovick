...
ALTER TABLE `livros`
  ...
  use moovick;
  INSERT INTO `usuarios` (`email`, `senha`, `apelido`, `nome_completo`, `data_nascimento`, `data_ingresso`, `caminho_foto`, `administrador`, `biografia`, `cod_verificador`, `verificado`) VALUES
('mbkdsilva@restinga.ifrs.edu.br', '2beac8d38937e66144769dd7b23c448f', 'Mateuszinho', 'Mateus Batista Kaufmann da Silva', '2002-05-08', '0000-00-00', 'uploads/caminho_fotos/803115c88521a3f5930e57b48852afae.jpg', 1, '18 Anos. Estudante do 4º Ano do Ensino Médio integrado ao curso Técnico em Informática do IFRS Campus Restinga. Desenvolvedor do Moovick', '107660-3', 1),
('erdmatos@restinga.ifrs.edu.br', '78bcc15a9c086c732e103df543a2ff41', 'Erica', 'Érica Ribeiro de Matos', '2002-01-19', '0000-00-00', '', 0, 'Estudante da Uniamérica.', '425202-3', 1);
